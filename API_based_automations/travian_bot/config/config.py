...
class Settings:
    ...
    REPORT_USE_INDICATOR: bool = True
    PROCESS_REPORTS_IN_AUTOMATION: bool = True
    REPORT_MAX_ITEMS_PER_PASS: int = 0  # 0 = unlimited
    ...
    def as_dict(self) -> dict:
        return {
            ...
            "REPORT_USE_INDICATOR": self.REPORT_USE_INDICATOR,
            "PROCESS_REPORTS_IN_AUTOMATION": self.PROCESS_REPORTS_IN_AUTOMATION,
            "REPORT_MAX_ITEMS_PER_PASS": self.REPORT_MAX_ITEMS_PER_PASS,
...
def load_settings(env_prefix: str = "") -> Settings:
    ...
    s.REPORT_USE_INDICATOR = _as_bool(g("REPORT_USE_INDICATOR", s.REPORT_USE_INDICATOR), s.REPORT_USE_INDICATOR)
    ...
    try:
        s.REPORT_MAX_ITEMS_PER_PASS = _as_int(g("REPORT_MAX_ITEMS_PER_PASS", s.REPORT_MAX_ITEMS_PER_PASS), s.REPORT_MAX_ITEMS_PER_PASS)
    except Exception:
        pass
